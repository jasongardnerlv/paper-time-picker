...
class PaperTimePicker extends mixinBehaviors([
  ...
  static get template() {
    return html`
        ...
        <div id="timePicker">
            ...
            <div id="clockArea">
                <div>
                    <iron-pages id="pages" class="clock-animatable" attr-for-selected="name" selected="{{view}}" entry-animation="fade-in-animation" exit-animation="fade-out-animation">
                        <div class="clock-animatable" name="hours">
                            <paper-clock-selector class="clock" id="hourClock" count="12" step="1" animated="[[animated]]" selected="{{hour12}}"></paper-clock-selector>
                        </div>
                        <div class="clock-animatable" name="minutes">
                        ...
                        <template is="dom-if" if="[[ enableSeconds ]]">
                            <div class="clock-animatable" name="seconds">
...
window.customElements.define(PaperTimePicker.is, PaperTimePicker);
