...
class PaperClockSelector extends mixinBehaviors([
...
`;
  ...
  _performRotation(angle, animate) {
  ...
  _applyAnimationEasing(progress) {
      return Math.pow(progress, 2);
  }

  _setHandRotation(deg, animate) {
...
window.customElements.define(PaperClockSelector.is, PaperClockSelector);
